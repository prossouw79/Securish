...
public partial class MainWindow
{
	...
	protected virtual void Build ()
	{
		...
		w5.Fill = false;
		// Container child hbox9.Gtk.Box+BoxChild
		this.spn_text_shift = new global::Gtk.SpinButton (0D, 100D, 1D);
		this.spn_text_shift.CanFocus = true;
		this.spn_text_shift.Name = "spn_text_shift";
		this.spn_text_shift.Adjustment.PageIncrement = 10D;
		this.spn_text_shift.ClimbRate = 1D;
		...
		w16.Fill = false;
		// Container child hbox10.Gtk.Box+BoxChild
		this.spn_file_shift = new global::Gtk.SpinButton (0D, 100D, 1D);
		this.spn_file_shift.CanFocus = true;
		this.spn_file_shift.Name = "spn_file_shift";
		this.spn_file_shift.Adjustment.PageIncrement = 10D;
		this.spn_file_shift.ClimbRate = 1D;
